...
<body>
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="hidden sm:ml-6 sm:block">
                        <div class="flex space-x-4">
                            ...
                            <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Galeri</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="max-w-6xl mx-auto px-4 mt-10">
        ...
        <p class="text-gray-800 font-bold text-center mt-2">
            Seluruh moment...
        </p>

        <!-- GRID GALERI -->
        <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">

            <!-- FOTO 1 -->
            <div class="bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:scale-105 transition">
                <img src="img/foto 1.jpeg" class="w-full h-56 object-cover">
                <div class="p-3 text-white text-center text-sm">Foto 1</div>
            </div>

            <!-- FOTO 2 -->
            <div class="bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:scale-105 transition">
                <img src="img/foto 2.jpeg" class="w-full h-56 object-cover">
                <div class="p-3 text-white text-center text-sm">Foto 2</div>
            </div>

            <!-- FOTO 3 -->
            <div class="bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:scale-105 transition">
                <img src="img/foto 3.jpeg" class="w-full h-56 object-cover">
                <div class="p-3 text-white text-center text-sm">Foto 3</div>
            </div>

            <!-- FOTO 4 -->
            <div class="bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:scale-105 transition">
                <img src="img/foto 4.jpeg" class="w-full h-56 object-cover">
                <div class="p-3 text-white text-center text-sm">Foto 4</div>
            </div>

            <!-- FOTO 5 -->
            <div class="bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:scale-105 transition">
                <img src="img/foto 5.jpeg" class="w-full h-56 object-cover">
                <div class="p-3 text-white text-center text-sm">Foto 5</div>
            </div>

            <!-- FOTO 6 -->
            <div class="bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:scale-105 transition">
                <img src="img/foto 6.jpeg" class="w-full h-56 object-cover">
                <div class="p-3 text-white text-center text-sm">Foto 6</div>
            </div>
