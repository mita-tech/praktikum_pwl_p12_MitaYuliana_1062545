...
<body>
    ...
    <div class="flex justify-center">
        <div class="mt-4 bg-gray-800 text-white rounded-2xl p-6 shadow-lg space-y-4 w-full max-w-md">

            <p class="text-gray-300">
                Silakan hubungi saya melalui media sosial di bawah ini:
            </p>

            <a href="https://www.instagram.com/mita.ylianaa?igsh=MW1wNWVucXU0ODRsYg=="
                target="_blank"
                class="flex items-center gap-3 bg-pink-500/10 hover:bg-pink-500/20 border border-pink-400/30
                  text-pink-300 px-4 py-3 rounded-xl transition">
                📸 Instagram: <span class="font-semibold">@mita.ylianaa</span>
            </a>
