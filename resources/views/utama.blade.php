...
<body>
    ...
    <!-- Card About -->
    <div class="mx-auto mt-16 max-w-3xl px-6">

        <div class="overflow-hidden rounded-3xl bg-gray-800 shadow-2xl ring-1 ring-white/10">

            <div class="md:flex">

                <!-- Foto -->
                <div class="flex items-center justify-center bg-gray-900 p-8 md:w-1/3">
                    <img src="img/mitaa.jpg"
                        alt="Foto Mita"
                        class="h-52 w-52 rounded-2xl object-cover shadow-lg ring-4 ring-indigo-500/30">
                </div>

                <!-- Isi -->
                <div class="p-8 md:w-2/3">

                    <span class="rounded-full bg-pink-500/20 px-3 py-1 text-sm font-medium text-pink-300 ring-1 ring-pink-500/30">
                        About Me
                    </span>

                    <h3 class="mt-4 text-3xl font-bold text-white leading-tight">
                        Halooo oll<br>
                        Welcome di mini web tentang Mitaa!
                    </h3>

                    <p class="mt-5 text-gray-300 leading-relaxed">
                        Hai haiii oll Kenalin nama ku
                        <span class="font-semibold text-indigo-400">
                            Mita Yuliana
                        </span>.
                        Ini adalah mini website sederhana yang berisi sedikit
                        informasi tentang diri ku. Yuk kenalan lebih jauh 
                    </p>

                    <!-- Button -->
                    <div class="mt-8">
                        <a href="about"
                            class="inline-flex items-center rounded-xl bg-indigo-500 px-5 py-3 text-sm font-semibold text-white shadow-lg hover:bg-indigo-400 transition">
                            Lihat Selengkapnya
                        </a>
                    </div>
